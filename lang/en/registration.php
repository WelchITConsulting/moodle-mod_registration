...
$string['downloadresponses']                = 'Download reponses';
...
$string['manage']                           = 'Manage registrations';
...
$string['view']                             = 'View registration';
$string['viewallresponses']                 = 'View all responses';
$string['viewsingleresponse']               = 'View single response';
