...
$string['registration:addinstance']         = 'Add registration events';
$string['registration:deleteresponses']     = 'Delete responses';
$string['registration:downloadresponses']   = 'Download reponses';
$string['registration:manage']              = 'Manage registrations';
$string['registration:submit']              = 'Submit registration';
$string['registration:view']                = 'View registration';
$string['registration:viewsingleresponse']  = 'View single response';
